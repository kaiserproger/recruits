...
public class Main {
    ...
    public static NetworkChannel SIMPLE_CHANNEL;
    ...
    private void setup(final FMLCommonSetupEvent event) {
        new DamageEvent().registerEvents();
        ...
        SIMPLE_CHANNEL = NetworkChannel.create(new ResourceLocation(Main.MOD_ID, "default"));
        ...
        for (int i = 0; i < messages.length; i++){
            SIMPLE_CHANNEL.register(messages[i], messages[i].getMethod(""));
