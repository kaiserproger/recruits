    ...
    public void notifyPlayersInTeam(String teamName, String otherTeamName, DiplomacyStatus relation, ServerLevel level) {
        ...
        if(team != null && otherTeam != null){
            ...
            for (ServerPlayer player : playersInTeam) {
                Main.SIMPLE_CHANNEL.sendToPlayer(player, new MessageToClientSetDiplomaticToast(relation.getByteValue(), otherTeam));
            }
            ...
            for (ServerPlayer player : playersInTeam2) {
                Main.SIMPLE_CHANNEL.sendToPlayer(player, new MessageToClientSetDiplomaticToast(relation.getByteValue() + 4, team));
            }
        }
